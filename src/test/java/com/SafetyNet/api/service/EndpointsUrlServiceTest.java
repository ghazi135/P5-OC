...
public class EndpointsUrlServiceTest {
    ...
    public void getMailsByCity() {
        ...
        assertThat(endpointUrlService.getMailsByCity("grenoble")
                                     .getEmail()
                                     .toString(), containsString("gbouzazi@gmail.com"));
        ;
    ...
    public void getPersonsByAddress() throws ParseException {
        ...
        List<PersonByAdressDTO> PersonByAdressDTOList = endpointUrlService.getPersonsByAddress("15 rue colonel dumont");
        for (PersonByAdressDTO PersonByAdressDTO : PersonByAdressDTOList) {
            assertThat(PersonByAdressDTO.getFirstname(), containsString("ghazi"));
        }
