...
public class FirestationControllerTest {
    ...
    public void addFirestation() throws Exception {
        ...
        // ACT
        MvcResult mvcResult = mockMvc.perform(post("/firestation").contentType(MediaType.APPLICATION_JSON)
                                                                  .content("{ \"address\":\"15 rue colonel dumont\", \"station\":\"10\" }"))
                                     .andDo(print())
                                     .andReturn();
        int status = mvcResult.getResponse().getStatus();
    ...
    public void updateFirestation() throws Exception {
        ...
        // ACT
        MvcResult mvcResult = mockMvc.perform(put("/firestation/Somewhere").contentType(MediaType.APPLICATION_JSON)
                                                                           .content("{\"address\":\"15 rue colonel dumont\"}"))
                                     .andDo(print())
                                     .andReturn();
        int status = mvcResult.getResponse().getStatus();
