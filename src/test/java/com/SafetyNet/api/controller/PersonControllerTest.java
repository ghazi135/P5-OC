...
public class PersonControllerTest {
    ...
    public void addPerson() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(post("/person").contentType(MediaType.APPLICATION_JSON)
                                                             .content("{\"firstName\":\"ZZZZ\"}"))
                                     .andDo(print())
                                     .andReturn();
        int status = mvcResult.getResponse().getStatus();
    ...
    public void updatePerson() throws Exception {
        ...
        // ACT
        MvcResult mvcResult = mockMvc.perform(put("/person/GhaziBouzazi").contentType(MediaType.APPLICATION_JSON)
                                                                         .content("{\"firstName\":\"ZZZZ\"}"))
                                     .andDo(print())
                                     .andReturn();
        int status = mvcResult.getResponse().getStatus();
